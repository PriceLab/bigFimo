...
maxGap.between.oc.and.gh <- 5000
   ...
   # this region includes all NDUFS2 eqtlswas discovered using viz function below
   # chr1:160,684,225-161,688,724
...
stopifnot(width(reduce(GRanges(tbl.oc.faux))) > 1000000)
